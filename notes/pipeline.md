...
> **[Figure 3 — PLACEHOLDER]** S_precision at CV-picked $\hat\mu$ across all five axes (n, p, p_edge, k_star, noise_scale), four lines: IAMB (deployed MB source), GES (global), bootstrap-L1 (predictive), vanilla floor. Source: `experiments/causal_prior/synthetic/recovery_figs.py` → `results/causal_prior/synthetic/recovery_figs/recovery_S_precision_all_axes.png`.
